package br.com.gonzaga.reflections;
...
public class AppReflections {
    public static void main(String[] args) {
        Class clazz = Produto.class; //pegando nome da classe
        ...
        try {
            ...
            for(Method m : Method) {
                ...
                if (m.getName().startsWith("get")) {
                    ...
                    for(Class classesTypes: m.getExceptionTypes()) {
                        if(classesTypes.equals(String.class)){
                            System.out.println(m.invoke(prod1, "Marcelo"));
